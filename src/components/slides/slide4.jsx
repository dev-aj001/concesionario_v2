    ...
    return (
        <div className="relative w-full h-full flex justify-center">
            ...
            <div className="absolute top-[65%] lg:top-3/4 left-2 sm:left-10 md:left-40 transform -translate-y-1/2 text-center sm:text-left text-white z-10 scale-[0.80] sm:scale-100">
                ...
                <Button color="#d87442" onClick={() => (window.location.href = "/cars")} variant="ghost" size="lg" className="backdrop-blur-sm transform transition duration-300 ease-in-out hover:scale-105 hover:backdrop-blur-lg">
